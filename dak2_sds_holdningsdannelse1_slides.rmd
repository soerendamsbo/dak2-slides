...
- Behov for procesorienteret model for **svar på holdningsspørgsmål** frem for at tænke holdninger som substantielle og sande ting

--

- Ikke så afgørende, at der ikke er konsensus om definition (selvstændig pointe)

- Indledende definition: Udtrykte tanker om eller evaluering af politiske spørgsmål, emner, personer (klima, uddannelse, skat, Mette Frederiksen, osv.)

- Omfatter *ikke* værdier, ideologi, grundholdning, m.m.

- Stærke og "krystaliserede" holdninger findes, men er undtagelsen der bekræfter reglen:
...
# Relaterede begreber i forskningen 

- **Holdning**, mening, indstilling (opinion, attitude)

- **Præference**, position 

- **Opfattelse**, tanker (belief, perception, thoughts) 

- **Affekt** og følelser (feelings, emotions, affect)

- **Adfærd** (behavior)

Vi kan langt henad vejen tænke på det hele som "holdninger" - i bred forstand
...
- Pludselig ikke længere mikroniveau &rarr; "den offentlige mening" som institution, der bl.a. lægger pres på politikere
...
- "the complex of beliefs expressed by a significant number of persons on an issue of public importance" (Hennessy 1967: 97-98)

__Pointen__: Når resultatet af *individual* holdningsdannelse opsummeres (og "taler" tydeligt) kan blive det blive en afgørende faktor i politik
...
30 års jubilæum i år (udkom i 1992) og er citeret mere end 14.000 gange

Generel og universel teori for holdningsdannelse
...
# Baggrund: Converse (1964) og ikke-holdninger
...
De fire antagelser, en efter en &rarr;
...
.pull-left[
```{r mindmap, out.width="95%", fig.cap="Kilde: Guo & McCombs (2016)"}
...
- En anden kanonisk holdningsdannelsesteori fra politisk psykologi: 
...
- Klimaholdninger i Danmark: 
    - Valgundersøgelsen: https://www.valgprojektet.dk/pages/page.asp?pid=308&l=dk
    - CONCITOs klimabarometer: https://concito.dk/emne/klimabarometeret
- Klimaholdninger i USA: 
