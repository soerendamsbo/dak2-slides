...
- Ofte ser vi **elitedominerede holdninger** og sommetimer *polarisering* (fx klima i USA)

--

- Note: Zallers er en **ekstremt indflydelsesrig teori** = at det er meget udbredt *tankegang* og *konceptualisering*<br>≠ at RAS-model altid anvendes eksplicit 
...
1. Taber & Lodge (2006) &mdash; **klassiker** i politisk psykologi (motivated reasoning) og genialt (kvasi)**eksperiment**
...
_Motivated reasoning = motivated skepticism = (politisk) motiveret tænkning_

- Holdningsdannelse er tænkning **drevet af forskellige motiver og mål**

> "[D]irectional ‘__motivated reasoning__’ [is a process] in which new information is processed in service of reaching a __pre-determined, desired conclusion__" (B&D)
...
- (2) **Politiske mål** &mdash; *partisan/directional*: at beskytte eller bestyrke eksisterende holdninger, identitet, gruppetilhørsforhold mv.
    - ofte hvad der menes med *motivated reasoning*

--

- **Krævende** at indsamle og processere ny information, men vi **kan motiveres** til at gøre det!
    - proces og resultat afhænger af **motivet** og **personen**
...
- _Hovedpointe_: sandsynligheden for (og måden hvorpå), man ændrer holdning i lyset af ny information **afhænger af ens eksisterende holdning**
...
- Den _opdaterede holdning_ kaldes **"posterior"**
...
- *Kan* føre til læring af "sandheden", men gør det ikke nødvendigvis

    - (motiv er ikke nok og meget kan gå galt)
...
- Kan altså fx påvirke **selve informationen**, man eksponeres for, den opfattede **troværdighed** og mobilisering af **modargumenter** (bemærk ligheder og forskelle ift. Zaller)

???

Forskel til Zaller: (1) Styring af hvilken information man eksponeres for, (2) prior attittudes vs. dybere prædispositioner 

---
class: middle

.pull-left[
# Kan I forestille jer nogle typiske situationer, hvor de fleste mennesker vil være motiveret af<br>(A) *mål om nøjagtighed* eller<br>(B) *politiske mål*
]
...
- Man stoler mere på information, som "giver mening" i forhold til ens eksisterende opfattelser - og påvirkes derfor *mere*<br>(*mindre* af udfordrende argumenter)
...
> "Greater scrutiny and counter-argumentation of information contrary to one’s prior beliefs (relative to information consistent with one’s prior beliefs)"<br>(Druckman & McGrath 2019)
...
- Tester motivated reasoning (= skepticism) *empirisk* med et **laboratorieeksperiment** (kvasieksperiment)
...
- Deltagere: 126 plus 136 statskundskabsstuderende (W.E.I.R.D?)
...
- **Indsamling** (ikke behandling) af information
...
.pull-left[
- Primært fokus: **Pro argumenter (%)** for personer, der selv er **Pro** vs. **Con** (vs 50/50)
...
- **Pro vælger flere Pro, Con vælger flere Con**
...
- **Resultat:** stærk evidens for **holdningspolarisering** blandt
...
## Motivated reasoning på klimaområdet
<br>
.center[
```{r, out.width='75%'}
include_graphics("media/sixamericas.png")
```
<br>.grey[Global Warming’s Six Americas (Leiserowitz et al. 2021)]]

???

```{r, out.width='75%', fig.cap="Global Warming’s Six Americas (Leiserowitz et al. 2021)"}
include_graphics("media/sixamericas0.png")
```
...
> "cognitive shortcuts that reduce complex problem-solving to more simple judgmental operations"<br>(Carmines & Huckfeldt 1998)

> "people who are confronted with a difﬁcult question sometimes answer an easier one instead"<br>(Kahneman 2003)
...
.grey[_Primær kilde: Lau & Redlawsk (2001)_]
...
- Men store &mdash; forudsigelige og politisk vigtige &mdash; forskelle i, hvordan vi danner holdninger pba. ny information:
    ...
    - vigtigste **kontekstvariable**: *information, information, information*<br>(hvorfra, hvor homogen eller polariseret diskurs)
    
    - og **spørgesituationen** (surveydesign, spørgsmål, framing, timing, tilgængelighed)

--

- Udbredt fokus på holdnings*ændringer* og mindre på *dannelse* i dybere forstand<br>(de spørgsmål har sine egne skoler, fx **politisk socialisering**)
...
4. MR = en **super stærk og udbredt teori.** Men kan være vanskelig at skelne *empirisk* fra andre forklaringer (fordi motiverne ikke kan observeres)
