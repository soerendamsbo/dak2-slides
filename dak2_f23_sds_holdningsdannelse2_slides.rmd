...
<!-- - Tal med James Druckman -->
<!-- - Tilføj motivated-reasoning figur: https://xebia.com/blog/mapping-biases-to-testing-confirmation-bias/ -->
<!-- - Fjern Bayes -->
<!-- - Tilføj flere eksempler på holdningsdannelse/adfærd: biologi/predispositions ("Predisposed"), social group identity ("Democracy for Realists"), Affect/System 1 ("Rationalizing voter"), moral systems ("...."), cognitive biases     -->
<!-- - Motivated reasoning: Damon Cann, Charles Taber, follow-up study. -->
<!-- - Six Americas: Engagement/knowledge U-shape with climate opinions (søg og skriv til Peter hvis ikke jeg finder). -->
<!-- - Om at motivated reasoning helt sikkert også driver forskere (illegitimt), se Anderson, Elizabeth. "Uses of Value Judgments in Science: A General Argument, with Lessons from a Case Study of Feminist Research on Divorce." Hypatia 19.1 (2004): "We need to ensure that value judgments do not operate to drive inquiry to a predetermined conclusion. This is our fundamental criterion for distinguishing legitimate from illegitimate uses of values in science" (p. 11). I en sammenhæng, hvor det diskuteres om det er godt/dårligt, (u)undgåeligt at bedrive videnskab, der drives af *værdier* (fx med udgangspunkt i feministisk teori). -->
